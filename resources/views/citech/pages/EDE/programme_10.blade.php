...
<section>
 ...
 <div id="container">
    ...
    <div class="box_1">
     ...
     <!-- cadre d'information -->
      <div class="cadre">
           <h1 class="pl-5 text-[25px]"><b>Programme de l’Executive Doctorate of Engineering sous la Direction du Professeur Alain RIVIERE</b>
           </h1> <br>
           
           <div>
            <img src="{{ asset('assets/upload/img/ede_programme.png') }}" alt="">
           </div>
      </div>
