        ...
        <div class="pl-5">
            <h1 style="font-size: 20px;">
                ...
                CONDITIONS D'ADMISSIBILITE 
                  ...
                  <br>        
                  <div class="pl-5">
                     <span><b>Soit une admission en EME1</b>
                     </span>
                  </div>
                     <br>
                     <div class="pl-5">
                        <span>
                            Pour pouvoir candidater vous devez être au moins titulaire d'une Licence (L3). Vous devez renseigner complétement votre dossier en ligne et vous assurez que les pièces jointes nécessaires sont bien téléchargées et lisibles. Vous ne pourrez pas passer le test d'admissibilité si ce n'est pas le cas.
                       ...
                       <br>
                       <div class="pl-5">
                          <span><b>Soit une admission en EME2</b>
                            <br>
                            <br>
                            Pour pouvoir candidater vous devez être au moins titulaire d'un M1 (anciennement une Maîtrise) en sciences des données ou informatique. Vous devez renseigner complétement votre dossier en ligne et vous assurez que les pièces jointes nécessaires sont bien téléchargées et lisibles. 
                          ...
                          <span>Possibilité de candidature par Validation des Acquis Professionnels (VAP) (*)</span>
                            ...
                            <br>
                               <div class="pl-5">
                                <span class="pl-5 text-[13px]">(*) Admissibilité par V.A.P. Validation des Acquis de l'Expérience (nombre de places limitées) : Si vous êtes titulaire d'un diplôme inférieur à l’exigence d’accès mais que vous avez une expérience professionnelle suffisante, vous pouvez toutefois candidater . 
                                    Votre dossier sera alors examiné par le jury qui décidera de vous permettre d'accéder à l’EME.
                                </span>
                               </div>
       </div>
