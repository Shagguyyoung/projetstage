       ...
       <div class="cadre">
        <div class="pl-5">
            <h1 style="font-size: 25px; font-weight: 700;">
                <strong>
                Une équipe pédagogique exceptionnelle dirigée le Pr Gérard BAGLIN
                </strong>
            </h1>
        </div>
                  <br>
                  <br>
                     <span class="pl-5 text-[20px]"><b>Gérard BAGLIN, </b>Professeur Émérite à HEC Paris, Auteur de 10 ouvrages sur la logistique, créateur de la plateforme e-Prélude
                     </span>
                       <br>
                       <br>
                          <span class="pl-5"><b>Marc ZHOLGADRI,</b>
                           Professeur des Universités à ISAE-ISM Paris, Directeur adjoint du Laboratoire QUARTZ.
                          </span>
                            <br>
                            <br>
                  <span class="pl-5"><b>Alain RIVIERE,</b>Professeur des Universités, Directeur de ISM Paris Executive Education</span>
                               <br>
               <span class="pl-5"><b>Irène FOGLIERINI, </b>Professeur à ESCP Europe, diplômée d’ESCP Europe</span>
                               <br>
                               <br>
                 <span class="pl-5"><b>Moncef HAMMADI, </b></span>
                                  <br>
                                  <br>
       <span class="pl-5"><b>Patrick GENIN,</b>
       Docteur en génie des systèmes industriels, Ingénieur des Ponts et Chaussées, chez Audemars Piguet Suisse
        </span>
        <br>
        <br>
        <span class="pl-5"><b>André THOMAS</b> 
        Docteur en génie des systèmes industriels, Habilité à diriger des recherches, Expert AFAV, CFPIM de l’APICS
         </span>
        <br>
        <br>
           <span class="pl-5 text-[20px]"><b>Jean-Luc JARRIN, </b>
        Chargé de cours à HEC, Ancien directeur Supply Chain chez Intermarché, Nestlé, Andros et Sephora
        </span>
           <br>
           <br>
              <span class="pl-5">
                 <b>Etienne LEFUR, </b>
                 Professeur Agrégé à l'Université Paris-Saclay, CPIM de l’APICS
              </span>
        <br>
        <br>
     <span class="pl-5"><b>Dany KARCHER, </b>Professeur à l’Université de Strasbourg, Enseignant en DUT QLIO</span>
