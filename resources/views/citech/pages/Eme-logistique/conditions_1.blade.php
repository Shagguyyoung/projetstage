        ...
        <div class="pl-5">
            <h1 style="font-size: 25px;">
                ...
                CONDITIONS D'ADMISSIBILITE 
                  ...
                  <br>
                  <div class="pl-5">
                     <span><b>Soit une admission en EME1</b>(durée 6 mois, choisir "S'inscrire en EME1" sur la page d'accueil)Pour pouvoir candidater vous devez être au moins titulaire d'un Licence (L3) . Vous devez renseigner complétement votre dossier en ligne et vous assurez que les pièces jointes nécessaires sont bien téléchargées et lisibles. Vous ne pourrez pas passer le test d'admissibilité si ce n'est pas le cas. 
...
Pour pouvoir candidater vous devez être au moins titulaire d'un M1 (anciennement une Maîtrise) en sciences de gestion. Vous devez renseigner complétement votre dossier en ligne et vous assurez que les pièces jointes nécessaires sont bien téléchargées et lisibles.
 Vous ne pourrez pas passer le test d'admissibilité si ce n'est pas le cas.
                          ...
                          <span>Possibilité de candidature par Validation des Acquis Professionnels (VAP) (*)</span>
                            ...
                            <br>
                            <br>
                  <span class="pl-5"><b>(*) Admissibilité par V.A.P. </b></span>
                               <br>
                               <div class="pl-5">
