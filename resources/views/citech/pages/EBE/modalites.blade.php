...
<section class="w-full">
    ...
    <div class="w-full lg:w-[88%] mx-auto mt-6 md:mt-8 mb-8 border-4 border-[#f24c21] p-4 md:p-6 lg:p-8 rounded-lg">
        ...
        <div class="space-y-4 md:space-y-6 text-justify">
            ...
            <p class="text-[#686D76] text-xs md:text-sm leading-relaxed">
            ...
            <div class="space-y-4">
                ...
                <p class="text-[#686D76] text-xs md:text-sm font-arial leading-relaxed">
                    <u>Acompte pré-inscription :</u> <strong>200 000 Fcfa</strong> à verser dès l'acceptation de votre candidature. Ce versement est nécessaire pour la validation de votre admission. Cette somme ne sera pas restituée si vous décidez de ne pas poursuivre.
                </p>
                ...
                <p class="text-[#686D76] text-xs md:text-sm font-arial leading-relaxed">
                    <u><strong>Financement</strong></u> : sur demande, expresse et motivée, des facilités de paiement peuvent être proposées par CAF (<a href="mailto:admissions@blearn.net" class="text-[#f24c21] hover:underline">admissions@blearn.net</a>)
                </p>
