...
<section>
 ...
 <div id="container">
        <div id="contain">
            ...
            <b><h3 style="color: #fff; font-size: 2.5rem; font-weight: bolder; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">EME EME 1 Finance</h3></b>
        </div>
    ...
    <div id="main">
     ...
     <!-- cadre d'information -->
       <div class="cadre">
        <div class="container">
    <div><h3 class="text_1" style="color: #fff">S'INSCRIRE à EME 1 Finance</h3></div>
    <div class="contain">
